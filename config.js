...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "JAMPAN-XD~",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "JAMPAN-XD",  // Bot's display name
    MODE: process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "255674229015",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || "",           // Owner's name
    
    DEV: process.env.DEV || "255674229015",                     // Developer's contact number
    
    // ===== AUTO-RESPONSE SETTINGS =====
    
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*JAMPAN-XD BOT VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/uj4jzr.jpg",  // Bot's "alive" image
